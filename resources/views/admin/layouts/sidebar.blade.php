<aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="nav-item nav-item-has-children">
                <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_users"
                    aria-controls="ddmenu_users" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <ul id="ddmenu_users" class="collapse dropdown-nav">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.users.trash') }}"> Thùng rác </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item nav-item-has-children">
            ...
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="ddmenu_products" class="collapse dropdown-nav">
                    ...
                    <li>
                        <a href="{{ route('admin.products.trash') }}"> Thùng Rác </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="ddmenu_stocks" class="collapse dropdown-nav">
                    <li>
                        <a href="{{ route('admin.stocks.index') }}"> Danh Sách Tồn Kho </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item nav-item-has-children">
                <a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_orders"
                    aria-controls="ddmenu_orders" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
